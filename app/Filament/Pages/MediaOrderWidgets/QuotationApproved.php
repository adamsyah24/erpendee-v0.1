    ...
    protected function getTableActions(): array
    {
        return [
            Tables\Actions\ActionGroup::make([
                ...
                Tables\Actions\Action::make('createMediaOrder')
                    ...
                    ->action(function (Order $record, array $data) {
                        MediaOrder::create([
                            ...
                            'order_series' => $record->order_series,
                    ...
                    ->form([
                        ...
                        Forms\Components\TextInput::make('order_series')
                            ->label('Order Series')
                            ->disabled()
                            ->default(fn (Order $record) => $record->order_series),
                ...
                // Tables\Actions\CreateAction::make(name: 'mediaOrder')
                // ->label('Create Media Order')
